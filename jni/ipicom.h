/*  -------------------------------------------------------------------------
    Copyright (C) 2013-2014 Intel Mobile Communications GmbH
     ...
     Revision Information:
       ...
       $$CC-Version: .../oint_drv_target_interface/9 $
       $$Date:       2014-01-24    9:07:25 UTC $
     ---------------------------------------------------------------------- */
...
\return void
*/
typedef void (*T_IPICOM_SOCKET_IND_CBF)(T_IPICOM_SH shdl, T_IPICOM_SOCKET_CBF_IND_TYPE ind_type, U32 user_value);
...
\return None
*/
typedef void (*T_IPICOM_SOCKET_PLP_IND_CBF)(T_IPICOM_SH shdl, T_IPICOM_PLP_CBF_IND_TYPE ind_type, U32 user_value);
...
\return T_IPICOM_ERROR - Error code.
*/
T_IPICOM_ERROR DLL_EXPORT IPICOM_socket_set_usrval(T_IPICOM_SH shdl, U32 user_value);
