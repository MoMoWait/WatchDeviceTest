...
public class SpeakerTestActivity extends AppBaseActivity {
	...
	private static final int MSG_SHOW_SPEAKER_DIALOG=2;
	private static final int MSG_TEST_TIME_END=3;
	...
	protected void onCreate(Bundle paramBundle) {
		...
		try {
			...
			AssetFileDescriptor fd = getAssets().openFd("cs06.mid");
...
//		mPlayer.setVolume(leftEnable ? 1 : 0, rightEnable ? 1 : 0);
	...
	protected void onPause() {
		...
		mHandler.removeMessages(MSG_SHOW_SPEAKER_DIALOG);
		if (this.mSpeakerOn)
			return;
	...
	protected void onResume() {
		...
		//mHandler.sendEmptyMessageDelayed(MSG_SHOW_LEFT_DIALOG, 3000);
                  //mHandler.sendEmptyMessageDelayed(MSG_SHOW_SPEAKER_DIALOG, 5000);
		...
		findViewById(R.id.btn_Fail).setVisibility(View.INVISIBLE);
		  ...
		  mHandler.sendEmptyMessageDelayed(MSG_TEST_TIME_END, 3000);
	}
	...
	private void showLeftDialog() {
		...
		.setMessage(R.string.LeftMsgBase)
	...
	private void showRightDialog() {
		new AlertDialog.Builder(this)
		.setMessage(R.string.RightMsgBase)
		.setPositiveButton(android.R.string.yes,
				new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog,
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case MSG_SHOW_RIGHT_DIALOG:
				showRightDialog();
				break;
			case MSG_SHOW_SPEAKER_DIALOG:
                                    showSpeakerDialog();
			case MSG_TEST_TIME_END: 
	...
	private void showSpeakerDialog() {
               new AlertDialog.Builder(this)
               .setMessage(R.string.SpeakerMsgBase)
               .setPositiveButton(android.R.string.yes,
                               new DialogInterface.OnClickListener() {
                                       @Override
                                       public void onClick(DialogInterface dialog,
