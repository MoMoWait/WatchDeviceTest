...
public class UsbHostTestActivity extends Activity {
    ...
    private static String usb_dir = "/mnt/usb_storage";
    ...
    private BroadcastReceiver mScanListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            LOG("mScanListener BroadcastReceiver action" + action + ", intent.getData().getPath(): " + intent.getData().getPath());
            if(action.equals(Intent.ACTION_MEDIA_MOUNTED)){
                LOG("in the mScanListener, ---- Intent.ACTION_MEDIA_MOUNTED");
                if(intent.getData().getPath().equals(usb_dir)){
                    TextView textView = (TextView) findViewById(R.id.linuxSupport);
                    textView.setText(getString(R.string.HardwareSupport));
                    testHostStorageState();
                    testReadAndWrite();
                }
            }
    ...
    StorageEventListener mStorageListener = new StorageEventListener() {
        ...
        public void onStorageStateChanged(String path, String oldState, String newState) {
            LOG("onStorageStateChanged - path: " + path + ", oldState: " + oldState + ", newState: " + newState);
        	if (path.equals(usb_dir) && newState.equals(Environment.MEDIA_MOUNTED)) {
                TextView textView = (TextView) findViewById(R.id.linuxSupport);
                textView.setText(getString(R.string.HardwareSupport));
                /*if (testDevDevice()) {
                    testHostStorageState();
