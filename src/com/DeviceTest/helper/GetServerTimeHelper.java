...
public class GetServerTimeHelper {
	...
	private String host = "cn.pool.ntp.org";

	public GetServerTimeHelper(final Context c) {
		new Thread() {
			public void run() {
				SntpClient client = new SntpClient();
				try {
					for(int i=10;;i--){
					if (client.requestTime(host, 40000)) {
						long now = client.getNtpTime() + System.nanoTime() / 1000 - client.getNtpTimeReference();
						android.provider.Settings.System.putInt(c.getContentResolver(), android.provider.Settings.System.AUTO_TIME_ZONE, 0);
						android.provider.Settings.System.putInt(c.getContentResolver(), android.provider.Settings.System.AUTO_TIME, 0);
						android.provider.Settings.System.putInt(c.getContentResolver(), android.provider.Settings.System.TIME_12_24, 24);
