...
public class BrightnessTestActivity extends AppBaseActivity implements OnClickListener{
...
//		initNumberPad();
	...
	protected void onResume() {
		...
		mHandler.sendEmptyMessageDelayed(MSG_SHOW_BTN, 1500);
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_Fail:
                         if(isBrightnessFirstTest){
                                ...
                                //((Button)findViewById(R.id.btn_Retest)).setClickable(false);
                                ((Button)findViewById(R.id.btn_Pass)).setClickable(false);
                                ((Button)findViewById(R.id.btn_Retest)).setClickable(false);//limi 9.7 add
